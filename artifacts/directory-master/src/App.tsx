...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/how-to-find-horse-riding-lessons-near-you/">
        <SetupGuard>
          <PublicLayout>
            <GuideArticlePage />
          </PublicLayout>
      ...
      <Route path="/what-to-wear-first-horse-riding-lesson/">
        <SetupGuard>
          <PublicLayout>
            <GuideArticlePage />
          </PublicLayout>
      ...
      <Route path="/english-vs-western-riding/">
        <SetupGuard>
          <PublicLayout>
            <GuideArticlePage />
          </PublicLayout>
