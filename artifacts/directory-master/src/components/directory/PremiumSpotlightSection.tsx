...
import { useGetPublicSettings, useGetPublicStats } from "@workspace/api-client-react";
          ...
          return (
            ...
            >
              ...
              <div className="p-5 flex flex-col flex-grow">
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div className="flex-1 min-w-0">
                    {showField("category") && entry.category && (
                      catQualified ? (
                        <Link href={getCategoryHubPath(entry.category)} className="inline-block mb-2">
                    ...
                    <h3 className="font-semibold text-gray-900 text-sm leading-snug line-clamp-2">
                      <Link href={entryHref} className="hover:text-amber-700 transition-colors">
                        {entry.title}
                      </Link>
                    </h3>
                  </div>
                ...
                <Link
                  href={entryHref}
                  className="w-full inline-flex items-center justify-center rounded-md px-3 py-2 group/btn text-xs font-medium text-amber-700 hover:text-amber-800 hover:bg-amber-50 border border-transparent hover:border-amber-200 transition-all mt-auto"
                >
                  View Details
